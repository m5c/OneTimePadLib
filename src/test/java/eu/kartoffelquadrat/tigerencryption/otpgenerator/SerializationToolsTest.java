...
public class SerializationToolsTest {
  ...
  public void testSerializeDeserialize() throws PadGeneratorException, CryptorException {
    ...
    EncryptedMessage aliceEnc01 = Cryptor.encryptMessage(alice01, pad, 0);
    EncryptedMessage bobEnc01 = Cryptor.encryptMessage(bob01, pad, 1);
    EncryptedMessage aliceEnc02 =
        Cryptor.encryptMessage(alice02, pad, aliceEnc01.getFollowUpChunkIndex());
    EncryptedMessage bobEnc02 =
        Cryptor.encryptMessage(bob02, pad, bobEnc01.getFollowUpChunkIndex());
    ...
    String decryptedMessage1 =
        new String(Cryptor.decryptMessage(deserializedConversation[0], pad, true));
    String decryptedMessage2 =
        new String(Cryptor.decryptMessage(deserializedConversation[1], pad, true));
    String decryptedMessage3 =
        new String(Cryptor.decryptMessage(deserializedConversation[2], pad, true));
    String decryptedMessage4 =
        new String(Cryptor.decryptMessage(deserializedConversation[3], pad, true));
